function pyramidMenu_v1(ref_table2, ref_size_list)
clc

%available options
list_n = size(ref_table2, 1);
list_options = ref_table2.Name;
n_levels_oly = length(ref_size_list);
ref_size_list = 1.335*ref_size_list/1024; %in GB; incl. pyramid extra 33%
...
btn.Text = 'Process';
    ...
    disp(sel_layer)
    disp(sel_level) 
    assignin("base", "sel_layer", sel_layer)
